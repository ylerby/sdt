...
func (a *App) SalesCountHandler(w http.ResponseWriter, r *http.Request) {
	var currentRequestBody requests.SalesCountRequestBody
	...
	result := a.Database.GetSalesCountRecord(currentRequestBody)
